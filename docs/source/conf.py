# -*- coding: utf-8 -*-
#
# confmgr documentation build configuration file, created by
...
import confmgr
import os, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(confmgr.__file__)))
...
version = confmgr.version.__version__
# The full version, including alpha/beta/rc tags.
release = confmgr.version.__version__
...
latex_documents = [
    (master_doc, 'confmgr.tex', u'confmgr Documentation',
...
man_pages = [
    (master_doc, 'confmgr', u'confmgr Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'confmgr', u'confmgr Documentation',
     author, 'confmgr', 'One line description of project.',
     'Miscellaneous'),
]
